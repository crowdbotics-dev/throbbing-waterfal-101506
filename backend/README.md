...
## Project Structure
    ...
    ├── throbbing_waterfal_101506  # Django project configurations
...
1. Clone this repo and `cd throbbing_waterfal_101506`
...
2. Clone this repo and `cd throbbing_waterfal_101506`
